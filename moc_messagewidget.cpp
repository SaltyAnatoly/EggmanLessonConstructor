...
QT_MOC_LITERAL(1, 14, 12), // "newImagePath"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 21) // "on_findButton_clicked"

    },
    "MessageWidget\0newImagePath\0\0"
...
void MessageWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->newImagePath((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        {
            typedef void (MessageWidget::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MessageWidget::newImagePath)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MessageWidget::newImagePath(QString _t1)
{
